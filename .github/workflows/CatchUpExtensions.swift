...
extension UIView {
    ...
    ///
    /// - Parameter cornerRadius: cornerRadius of UIView. Default value is 12.0
    func setCornerRadius(_ cornerRadius: CGFloat = 12) {
